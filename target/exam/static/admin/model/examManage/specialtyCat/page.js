myApp.controller('specialtyCatController', function ($rootScope, $scope, services, $sce, $stateParams) {
    ...
    $scope.tableControl = {
        config: {
            ...
            columns: [
                {field: 'dic_code', title: "专业编码", align: 'left'},
                {field: 'dic_name', title: "专业名称", align: 'left'},
                {field: 'dic_alias', title: "专业别名", align: 'left'},
        ...
        reload: function (param) {
            services._eMDictionary(param).success(function (res) {
    ...
    $scope._form_submit = function (bool) {
        ...
        $scope.selRow.dic_parentcode="20000";
    ...
    $scope.reload = function (key, value) {
        $scope.tableControl.config.param["dic_code"] = "20000";
