myApp.controller('subjectTypeCatController', function ($rootScope, $scope, services, $sce, $stateParams) {
    ...
    $scope.tableControl = {
        config: {
            ...
            columns: [
                {field: 'dic_code', title: "题型编码", align: 'left'},
                {field: 'dic_name', title: "题型名称", align: 'left'},
    ...
    $scope._form_submit = function () {
        ...
        $scope.selRow.dic_parentcode="60000";
    ...
    $scope.reload = function (key, value) {
        $scope.tableControl.config.param["dic_code"] = "60000";
