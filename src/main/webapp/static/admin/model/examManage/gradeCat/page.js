myApp.controller('gradeCatController', function ($rootScope, $scope, services, $sce, $stateParams) {
    ...
    $scope.tableControl = {
        config: {
            ...
            columns: [
                {field: 'dic_code', title: "年级编码", align: 'left'},
                {field: 'dic_name', title: "年级名称", align: 'left'},
                {field: 'dic_alias', title: "年级别名", align: 'left'},
    ...
    $scope._form_submit = function (bool) {
        ...
        $scope.selRow.dic_parentcode = myCode;
    ...
    $scope.reload = function (key, value) {
        $scope.tableControl.config.param["dic_code"] = myCode;
